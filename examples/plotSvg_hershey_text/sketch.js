// Display an inlined Hershey font in p5.js from 
// https://github.com/techninja/hersheytextjs
// Adapted from "hershey font json example" by Allison Parrish,
...
function draw(){
  ...
  drawString("abcdefghijklmnopqrstuvwxyz", 50,110, 1.0);
  drawString("1234567890", 50,150, 1.0);
  drawString("!@#$%^&*()?{}[]()<>,.;:'\"", 50,190, 1.0);
...
function getPathCommandsForChar(s, offset) {
  ...
  instr.push({type: 'E', 'x': 0, 'y': 0}); // endSvgGroup
  return instr;
}

//--------------------------------------------
// draw commands. 
// Note, this has been modified to use p5.plotSvg's SVG group commands.
