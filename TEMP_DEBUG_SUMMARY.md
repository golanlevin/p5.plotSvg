...
- The next recording-local state batch has also moved into `session`: current stroke color, non-default stroke tracking, export group depth, and transform-existence tracking.
