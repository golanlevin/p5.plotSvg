...
function setup() {
  ...
  window.runSmorgasbordExport = function() {
...
function drawDesign(){
  ...
  vertex(300, 340);
  bezierOrder(2);
  bezierVertex(360, 340);
  bezierVertex(330, 370);
  bezierVertex(300, 400);
  bezierVertex(360, 400);
  bezierOrder(3);
  vertex(360, 330);
  vertex(300, 330);
  endShape();
  ...
  vertex(300, 420);
  bezierOrder(2);
  bezierVertex(360, 420);
  bezierVertex(330, 450);
  bezierVertex(300, 480);
  bezierVertex(360, 480);
  bezierOrder(3);
  vertex(360, 410);
  vertex(300, 410);
  endShape(CLOSE);
  ...
  beginShape();
  vertex(430, 320);
  bezierVertex(480, 300);
  bezierVertex(480, 375);
  bezierVertex(430, 375);
  bezierVertex(450, 380);
  bezierVertex(460, 325);
  bezierVertex(430, 320);
  endShape();
  
  beginShape();
  vertex      (400, 420);
  bezierVertex(400, 420); bezierVertex(410, 400); bezierVertex(420, 420);
  bezierVertex(420, 420); bezierVertex(430, 440); bezierVertex(440, 420);
  bezierVertex(440, 420); bezierVertex(450, 400); bezierVertex(460, 420);
  vertex      (460, 460);
  vertex      (400, 460);
  vertex      (400, 420);
  endShape();
  ...
  beginShape();
  vertex(      530, 470); 
  bezierVertex(525, 425); bezierVertex(600, 450); bezierVertex(550, 500);
  bezierVertex(550, 540); bezierVertex(575, 540); bezierVertex(600, 520); 
  endShape();

  beginShape();
  vertex(      530, 370); 
  bezierVertex(525, 325); bezierVertex(600, 350); bezierVertex(550, 400);
  bezierVertex(520, 430); bezierVertex(575, 440); bezierVertex(600, 420); 
  endShape();
  ...
  vertex(275, 500); 
  vertex(280, 500); 
  bezierVertex(300,500); bezierVertex(310,530); bezierVertex(325,530);
  bezierVertex(340,530); bezierVertex(350,500); bezierVertex(370,500);
  vertex(375, 500);
  vertex(375, 540);
  vertex(275, 540);
  endShape(CLOSE); 
  ...
  vertex(350, 595);
  bezierOrder(2);
  bezierVertex(325,540);
  bezierVertex(300,595);
  bezierOrder(3);
  vertex(300, 595);
  vertex(275, 590);
  endShape(CLOSE); 
  ...
  for (let j=0; j<7; j++){
    beginShape();
    for (let i=0; i<j; i++){
      splineVertex(cpts[i][0] + 15*j,cpts[i][1]);
    }
    endShape();
  }
  splineProperty('ends', INCLUDE);
