...
(function(global) {
  ...
  let _svgBezierOrder = 3;               // p5.js v2 bezierVertex() point-stream order
  let _svgSplineEndsMode = null;         // p5.js v2 splineProperty('ends') value
  ...
  let _bCurveVertexCompatActive = false;
  let _curveVertexCompatPreviousEndsMode;
  ...
  let _originalSplinePropertyFunc;
  let _originalSplinePropertiesFunc;
  ...
  function getOriginalFunction(funcName) {
    ...
    if (_bUsingGlobalMode && globalTarget && typeof globalTarget[funcName] === 'function') {
      return globalTarget[funcName];
    }
    if (_p5Instance && typeof _p5Instance[funcName] === 'function') {
      return _p5Instance[funcName];
    }
  ...
  function callOriginalFunction(originalFunc, thisArg, args) {
    ...
    const wasRecording = _bRecordingSvg;
    _bRecordingSvg = false;
    try {
      return originalFunc.apply(thisArg, args);
    } finally {
      _bRecordingSvg = wasRecording;
    }
  }
  ...
  function isWebGLDrawingContext() {
    ...
    return !!(WebGLCtor && _p5Instance?._renderer?.drawingContext instanceof WebGLCtor);
  }
  ...
  p5plotSvg.beginRecordSvg = function(p5Instance, fn) {
    ...
    const globalTarget = getGlobalTarget();
    _bUsingGlobalMode = (p5Instance === globalTarget);
    if (_p5MajorVersion >= 2 && _bUsingGlobalMode && typeof p5.instance !== 'undefined') {
      _p5Instance = p5.instance;
    } else {
      _p5Instance = p5Instance;
    }
    _p5PixelDensity = _p5Instance.pixelDensity();
    _svgBezierOrder = getCurrentBezierOrder();
    _svgCurveTightness = getCurrentSplineTightness();
    _svgSplineEndsMode = getCurrentSplineEndsMode();
    _bCurveVertexCompatActive = false;
    _curveVertexCompatPreviousEndsMode = undefined;
  ...
  function restoreP5Functions(){
    ...
    restoreFunction(globalTarget, 'arc', _originalArcFunc);
    restoreFunction(_p5Instance, 'bezier', _originalBezierFunc);
    restoreFunction(globalTarget, 'bezier', _originalBezierFunc);
    restoreFunction(_p5Instance, 'circle', _originalCircleFunc);
    restoreFunction(globalTarget, 'circle', _originalCircleFunc);
    restoreFunction(_p5Instance, 'curve', _originalCurveFunc);
    restoreFunction(globalTarget, 'curve', _originalCurveFunc);
    restoreFunction(_p5Instance, 'spline', _originalSplineFunc);
    restoreFunction(globalTarget, 'spline', _originalSplineFunc);
    restoreFunction(_p5Instance, 'ellipse', _originalEllipseFunc);
    restoreFunction(globalTarget, 'ellipse', _originalEllipseFunc);
    restoreFunction(_p5Instance, 'line', _originalLineFunc);
    restoreFunction(globalTarget, 'line', _originalLineFunc);
    restoreFunction(_p5Instance, 'point', _originalPointFunc);
    restoreFunction(globalTarget, 'point', _originalPointFunc);
    restoreFunction(_p5Instance, 'quad', _originalQuadFunc);
    restoreFunction(globalTarget, 'quad', _originalQuadFunc);
    restoreFunction(_p5Instance, 'rect', _originalRectFunc);
    restoreFunction(globalTarget, 'rect', _originalRectFunc);
    restoreFunction(_p5Instance, 'square', _originalSquareFunc);
    restoreFunction(globalTarget, 'square', _originalSquareFunc);
    restoreFunction(_p5Instance, 'triangle', _originalTriangleFunc);
    restoreFunction(globalTarget, 'triangle', _originalTriangleFunc);
    restoreFunction(_p5Instance, 'bezierDetail', _originalBezierDetailFunc);
    restoreFunction(_p5Instance, 'curveTightness', _originalCurveTightnessFunc);
    restoreFunction(globalTarget, 'curveTightness', _originalCurveTightnessFunc);
    restoreFunction(_p5Instance, 'bezierOrder', _originalBezierOrderFunc);
    restoreFunction(globalTarget, 'bezierOrder', _originalBezierOrderFunc);
    restoreFunction(_p5Instance, 'splineProperty', _originalSplinePropertyFunc);
    restoreFunction(globalTarget, 'splineProperty', _originalSplinePropertyFunc);
    restoreFunction(_p5Instance, 'splineProperties', _originalSplinePropertiesFunc);
    restoreFunction(globalTarget, 'splineProperties', _originalSplinePropertiesFunc);

    restoreFunction(_p5Instance, 'beginShape', _originalBeginShapeFunc);
    restoreFunction(globalTarget, 'beginShape', _originalBeginShapeFunc);
    restoreFunction(_p5Instance, 'vertex', _originalVertexFunc);
    restoreFunction(globalTarget, 'vertex', _originalVertexFunc);
    restoreFunction(_p5Instance, 'bezierVertex', _originalBezierVertexFunc);
    restoreFunction(globalTarget, 'bezierVertex', _originalBezierVertexFunc);
    restoreFunction(_p5Instance, 'quadraticVertex', _originalQuadraticVertexFunc);
    restoreFunction(globalTarget, 'quadraticVertex', _originalQuadraticVertexFunc);
    restoreFunction(_p5Instance, 'curveVertex', _originalCurveVertexFunc);
    restoreFunction(globalTarget, 'curveVertex', _originalCurveVertexFunc);
    restoreFunction(_p5Instance, 'splineVertex', _originalSplineVertexFunc);
    restoreFunction(globalTarget, 'splineVertex', _originalSplineVertexFunc);
    restoreFunction(_p5Instance, 'beginContour', _originalBeginContourFunc);
    restoreFunction(globalTarget, 'beginContour', _originalBeginContourFunc);
    restoreFunction(_p5Instance, 'endContour', _originalEndContourFunc);
    restoreFunction(globalTarget, 'endContour', _originalEndContourFunc);
    restoreFunction(_p5Instance, 'endShape', _originalEndShapeFunc);
    restoreFunction(globalTarget, 'endShape', _originalEndShapeFunc);
    
    restoreFunction(_p5Instance, 'describe', _originalDescribeFunc);
    restoreFunction(globalTarget, 'describe', _originalDescribeFunc);
    restoreFunction(_p5Instance, 'push', _originalPushFunc);
    restoreFunction(globalTarget, 'push', _originalPushFunc);
    restoreFunction(_p5Instance, 'pop', _originalPopFunc);
    restoreFunction(globalTarget, 'pop', _originalPopFunc);
    restoreFunction(_p5Instance, 'scale', _originalScaleFunc);
    restoreFunction(globalTarget, 'scale', _originalScaleFunc);
    restoreFunction(_p5Instance, 'translate', _originalTranslateFunc);
    restoreFunction(globalTarget, 'translate', _originalTranslateFunc);
    restoreFunction(_p5Instance, 'rotate', _originalRotateFunc);
    restoreFunction(globalTarget, 'rotate', _originalRotateFunc);
    restoreFunction(_p5Instance, 'shearX', _originalShearXFunc);
    restoreFunction(globalTarget, 'shearX', _originalShearXFunc);
    restoreFunction(_p5Instance, 'shearY', _originalShearYFunc);
    restoreFunction(globalTarget, 'shearY', _originalShearYFunc);
    restoreFunction(_p5Instance, 'text', _originalTextFunc);
    restoreFunction(globalTarget, 'text', _originalTextFunc);
    restoreFunction(_p5Instance, 'stroke', _originalStrokeFunc);
    restoreFunction(globalTarget, 'stroke', _originalStrokeFunc);
    restoreFunction(_p5Instance, 'colorMode', _originalColorModeFunc);
    restoreFunction(globalTarget, 'colorMode', _originalColorModeFunc);
    restoreFunction(_p5Instance, 'clip', _originalClipFunc);
    restoreFunction(globalTarget, 'clip', _originalClipFunc);
  }
  ...
  function overrideArcFunction() {
    ...
    _originalArcFunc = getOriginalFunction('arc');
    const newArcFunc = function(x, y, w, h, start, stop, mode = OPEN, detail = 0) {
      ...
      callOriginalFunction(_originalArcFunc, _p5Instance, arguments);
    };
  ...
  function overrideCircleFunction(){
    ...
    _originalCircleFunc = getOriginalFunction('circle');
    const newCircleFunc = function(x, y, d) {
      ...
      callOriginalFunction(_originalCircleFunc, _p5Instance, argumentsCopy);
    };
  ...
  function overrideCurveFunction() {
    _originalCurveFunc = getOriginalFunction('curve');
    if (_p5MajorVersion >= 2) {
      const curveCompatFunc = function(x1, y1, x2, y2, x3, y3, x4, y4) {
        ...
        const drawCurve = () => callOriginalFunction(_originalSplineFunc, _p5Instance, argumentsCopy);
        if (typeof _originalSplineFunc === 'function') {
          withTemporarySplineEndsMode(getP5Constant('EXCLUDE'), drawCurve);
        }
      };
      overrideFunction(_p5Instance, 'curve', curveCompatFunc);
    ...
    const newCurveFunc = function(x1, y1, x2, y2, x3, y3, x4, y4) {
      ...
      callOriginalFunction(_originalCurveFunc, _p5Instance, argumentsCopy);
    };
  ...
  function overrideSplineFunction() {
    _originalSplineFunc = getOriginalFunction('spline');
    if (typeof _originalSplineFunc !== 'function') return;
    ...
    const newSplineFunc = function(x1, y1, x2, y2, x3, y3, x4, y4) {
      ...
      callOriginalFunction(_originalSplineFunc, _p5Instance, argumentsCopy);
    };
    overrideFunction(_p5Instance, 'spline', newSplineFunc);
  ...
  */
  function overrideEllipseFunction(){
    ...
    _originalEllipseFunc = getOriginalFunction('ellipse');
    const newEllipseFunc = function(x, y, w, h, detail = 0) {
      ...
      callOriginalFunction(_originalEllipseFunc, _p5Instance, argumentsCopy);
    };
  ...
  function overrideLineFunction() {
    ...
    _originalLineFunc = getOriginalFunction('line');
    const newLineFunc = function(x1, y1, x2, y2) {
      if (_bRecordingSvg) {
        let transformMatrix = captureCurrentTransformMatrix();
        _commands.push({ type: 'line', x1, y1, x2, y2, transformMatrix });
      }
      callOriginalFunction(_originalLineFunc, _p5Instance, arguments);
    };
  ...
  function overridePointFunction() {
    ...
    _originalPointFunc = getOriginalFunction('point');
    const newPointFunc = function(x, y) {
      if (_bRecordingSvg) {
        let transformMatrix = captureCurrentTransformMatrix();
        _commands.push({ type: 'point', x, y, radius: _svgPointRadius, transformMatrix });
      }
      callOriginalFunction(_originalPointFunc, _p5Instance, arguments);
    };
  ...
  function overrideRectFunction() {
    ...
    _originalRectFunc = getOriginalFunction('rect');
    const newRectFunc = function(x, y, w, h, tl, tr, br, bl) {
      ...
      callOriginalFunction(_originalRectFunc, _p5Instance, argumentsCopy);
    };
  ...
  function overrideSquareFunction(){
    ...
    _originalSquareFunc = getOriginalFunction('square');
    const newSquareFunc = function(x, y, s, tl, tr, br, bl) {
      ...
      callOriginalFunction(_originalSquareFunc, _p5Instance, argumentsCopy);
    };
  ...
  function overrideTriangleFunction(){
    ...
    _originalTriangleFunc = getOriginalFunction('triangle');
    const newTriangleFunc = function(x1, y1, x2, y2, x3, y3) {
      if (_bRecordingSvg) {
        let transformMatrix = captureCurrentTransformMatrix();
        _commands.push({ type: 'triangle', x1, y1, x2, y2, x3, y3, transformMatrix });
      }
      callOriginalFunction(_originalTriangleFunc, _p5Instance, arguments);
    };
  ...
  function overrideBezierDetailFunction() {
    _originalBezierDetailFunc = getOriginalFunction('bezierDetail');
    if (typeof _originalBezierDetailFunc !== 'function') return;
    _p5Instance.bezierDetail = function(detailLevel) { // Check if the renderer is WEBGL
      ...
      callOriginalFunction(_originalBezierDetailFunc, _p5Instance, arguments);
    };
  }
  ...
  function overrideCurveTightnessFunction() {
    _originalCurveTightnessFunc = getOriginalFunction('curveTightness');
    if (_p5MajorVersion >= 2) {
      ...
      overrideFunction(_p5Instance, 'curveTightness', curveTightnessCompatFunc);
    ...
    _p5Instance.curveTightness = function(tightness) {
      ...
      callOriginalFunction(_originalCurveTightnessFunc, _p5Instance, arguments);
    };
    overrideFunction(getGlobalTarget(), 'curveTightness', _p5Instance.curveTightness);
  }
  ...
  function overrideBezierOrderFunction() {
    _originalBezierOrderFunc = getOriginalFunction('bezierOrder');
    if (typeof _originalBezierOrderFunc !== 'function') return;

    const newBezierOrderFunc = function(order) {
      if (typeof order !== 'undefined') {
        _svgBezierOrder = order;
      }
      return callOriginalFunction(_originalBezierOrderFunc, _p5Instance, arguments);
    };
    overrideFunction(_p5Instance, 'bezierOrder', newBezierOrderFunc);
  ...
  function overrideSplinePropertyFunction() {
    _originalSplinePropertyFunc = getOriginalFunction('splineProperty');
    if (typeof _originalSplinePropertyFunc !== 'function') return;

    const newSplinePropertyFunc = function(property, value) {
      const ret = callOriginalFunction(_originalSplinePropertyFunc, _p5Instance, arguments);
      if (typeof value !== 'undefined') {
        if (property === 'tightness') {
          _svgCurveTightness = value;
        } else if (property === 'ends') {
          _svgSplineEndsMode = value;
        }
      }
      return ret;
    };
    overrideFunction(_p5Instance, 'splineProperty', newSplinePropertyFunc);
  ...
  function overrideSplinePropertiesFunction() {
    _originalSplinePropertiesFunc = getOriginalFunction('splineProperties');
    if (typeof _originalSplinePropertiesFunc !== 'function') return;

    const newSplinePropertiesFunc = function(values) {
      const ret = callOriginalFunction(_originalSplinePropertiesFunc, _p5Instance, arguments);
      if (values && typeof values === 'object') {
        if (Object.prototype.hasOwnProperty.call(values, 'tightness')) {
          _svgCurveTightness = values.tightness;
        }
        if (Object.prototype.hasOwnProperty.call(values, 'ends')) {
          _svgSplineEndsMode = values.ends;
        }
      }
      return ret;
    };
    overrideFunction(_p5Instance, 'splineProperties', newSplinePropertiesFunc);
  ...
  function overrideBeginShapeFunction() {
    _originalBeginShapeFunc = getOriginalFunction('beginShape');
    const newBeginShapeFunc = function(kind) {
      if (_bRecordingSvg) { 
        ...
        if ((kind !== null) && (kind === 0 || (typeof _p5Instance.POINTS !== 'undefined' && kind === _p5Instance.POINTS))) {
          _shapeKind = 'points'; 
      ...
      callOriginalFunction(_originalBeginShapeFunc, _p5Instance, arguments);
    };
    overrideFunction(_p5Instance, 'beginShape', newBeginShapeFunc);
  ...
  function overrideVertexFunction() {
    _originalVertexFunc = getOriginalFunction('vertex');
    const newVertexFunc = function(x, y) {
      if (_bRecordingSvg) {
        _vertexStack.push({ type: 'vertex', x, y });
      }
      callOriginalFunction(_originalVertexFunc, _p5Instance, arguments);
    };
    overrideFunction(_p5Instance, 'vertex', newVertexFunc);
  ...
  function overrideBezierVertexFunction() {
    ...
    _originalBezierVertexFunc = getOriginalFunction('bezierVertex');
    const newBezierVertexFunc = function(x2, y2, x3, y3, x4, y4) {
      if (_bRecordingSvg) {
        _shapeMode = 'complex'; // Switch to complex mode
        if (_p5MajorVersion >= 2 && arguments.length <= 5) {
          _vertexStack.push({
            type: 'bezierPoint',
            x: x2,
            y: y2,
      ...
      callOriginalFunction(_originalBezierVertexFunc, _p5Instance, arguments);
    };
    overrideFunction(_p5Instance, 'bezierVertex', newBezierVertexFunc);
  ...
  function overrideQuadraticVertexFunction() {
    ...
    _originalQuadraticVertexFunc = getOriginalFunction('quadraticVertex');
    if (typeof _originalQuadraticVertexFunc !== 'function' && _p5MajorVersion < 2) return;
    const newQuadraticVertexFunc = function(cx, cy, x, y) {
      ...
      if (_p5MajorVersion >= 2) {
        ...
        callOriginalFunction(_originalBezierVertexFunc, _p5Instance, [cx, cy]);
        callOriginalFunction(_originalBezierVertexFunc, _p5Instance, [x, y]);
        setOriginalBezierOrder(previousOrder);
      } else {
        callOriginalFunction(_originalQuadraticVertexFunc, _p5Instance, arguments);
      }
    };
    overrideFunction(_p5Instance, 'quadraticVertex', newQuadraticVertexFunc);
  ...
  function overrideCurveVertexFunction() {
    ...
    _originalCurveVertexFunc = getOriginalFunction('curveVertex');
    if (typeof _originalCurveVertexFunc !== 'function' && _p5MajorVersion < 2) return;
    const newCurveVertexFunc = function(x, y) {
      ...
      if (_p5MajorVersion >= 2) {
        ...
        callOriginalFunction(_originalSplineVertexFunc, _p5Instance, arguments);
      } else {
        callOriginalFunction(_originalCurveVertexFunc, _p5Instance, arguments);
      }
    };
    overrideFunction(_p5Instance, 'curveVertex', newCurveVertexFunc);
  ...
  function overrideSplineVertexFunction() {
    _originalSplineVertexFunc = getOriginalFunction('splineVertex');
    if (typeof _originalSplineVertexFunc !== 'function') return;
    ...
    overrideFunction(_p5Instance, 'splineVertex', newSplineVertexFunc);
  ...
  function overrideBeginContourFunction() {
    _originalBeginContourFunc = getOriginalFunction('beginContour');
    if (typeof _originalBeginContourFunc !== 'function') return;
    const newBeginContourFunc = function() {
      if (_bRecordingSvg) {
        _vertexStack.push({ type: 'contourStart' });
      }
      callOriginalFunction(_originalBeginContourFunc, _p5Instance, arguments);
    };
    overrideFunction(_p5Instance, 'beginContour', newBeginContourFunc);
  ...
  function overrideEndContourFunction() {
    _originalEndContourFunc = getOriginalFunction('endContour');
    if (typeof _originalEndContourFunc !== 'function') return;
    const newEndContourFunc = function(mode) {
      if (_bRecordingSvg) {
        let isClosed = (mode === _p5Instance.CLOSE);
        _vertexStack.push({ type: 'contourEnd', closed: isClosed });
      }
      callOriginalFunction(_originalEndContourFunc, _p5Instance, arguments);
    };
    overrideFunction(_p5Instance, 'endContour', newEndContourFunc);
  ...
  function overrideEndShapeFunction() {
    _originalEndShapeFunc = getOriginalFunction('endShape');
    const newEndShapeFunc = function(mode) {
      if (_bRecordingSvg && _vertexStack.length > 0) {
        ...
        switch (_shapeKind) {
          ...
          default:
            ...
            let hasContours = _vertexStack.some(v => v.type === 'contourStart');
      ...
      try {
        callOriginalFunction(_originalEndShapeFunc, _p5Instance, arguments);
      } finally {
        if (_p5MajorVersion >= 2) {
    ...
    overrideFunction(_p5Instance, 'endShape', newEndShapeFunc);
  ...
  function overrideDescribeFunction() {
    _originalDescribeFunc = getOriginalFunction('describe');
    if (typeof _originalDescribeFunc !== 'function') return;
    const newDescribeFunc = function(description) {
      ...
      callOriginalFunction(_originalDescribeFunc, _p5Instance, arguments);
    };
    overrideFunction(_p5Instance, 'describe', newDescribeFunc);
  ...
  function overridePushFunction(){
    _originalPushFunc = getOriginalFunction('push');
    _bTransformsExist = true; 
    const newPushFunc = function() {
      if (_bRecordingSvg) {
        _commands.push({ type: 'push' });
      }
      callOriginalFunction(_originalPushFunc, _p5Instance, arguments);
    };
    overrideFunction(_p5Instance, 'push', newPushFunc);
  ...
  function overridePopFunction(){
    _originalPopFunc = getOriginalFunction('pop');
    _bTransformsExist = true; 
    const newPopFunc = function() {
      if (_bRecordingSvg) {
        _commands.push({ type: 'pop' });
      }
      callOriginalFunction(_originalPopFunc, _p5Instance, arguments);
    };
    overrideFunction(_p5Instance, 'pop', newPopFunc);
  ...
  function overrideScaleFunction(){
    _originalScaleFunc = getOriginalFunction('scale');
    _bTransformsExist = true; 
    const newScaleFunc = function(sx, sy) {
      if (_bRecordingSvg) {
        _commands.push({ type: 'scale', sx, sy: sy || sx });
      }
      callOriginalFunction(_originalScaleFunc, _p5Instance, arguments);
    };
    overrideFunction(_p5Instance, 'scale', newScaleFunc);
  ...
  function overrideTranslateFunction(){
    _originalTranslateFunc = getOriginalFunction('translate');
    _bTransformsExist = true; 
    const newTranslateFunc = function(tx, ty) {
      if (_bRecordingSvg) {
        _commands.push({ type: 'translate', tx, ty });
      }
      callOriginalFunction(_originalTranslateFunc, _p5Instance, arguments);
    };
    overrideFunction(_p5Instance, 'translate', newTranslateFunc);
  ...
  function overrideRotateFunction(){
    _originalRotateFunc = getOriginalFunction('rotate');
    _bTransformsExist = true; 
    const newRotateFunc = function(angle) {
      if (_bRecordingSvg) {
        _commands.push({ type: 'rotate', angle });
      }
      callOriginalFunction(_originalRotateFunc, _p5Instance, arguments);
    };
    overrideFunction(_p5Instance, 'rotate', newRotateFunc);
  ...
  function overrideShearXFunction(){
    _originalShearXFunc = getOriginalFunction('shearX');
    _bTransformsExist = true; 
    const newShearXFunc = function(angle) {
      if (_bRecordingSvg) {
        _commands.push({ type: 'shearx', angle });
      }
      callOriginalFunction(_originalShearXFunc, _p5Instance, arguments);
    };
    overrideFunction(_p5Instance, 'shearX', newShearXFunc);
  ...
  function overrideShearYFunction(){
    _originalShearYFunc = getOriginalFunction('shearY');
    _bTransformsExist = true; 
    const newShearYFunc = function(angle) {
      if (_bRecordingSvg) {
        _commands.push({ type: 'sheary', angle });
      }
      callOriginalFunction(_originalShearYFunc, _p5Instance, arguments);
    };
    overrideFunction(_p5Instance, 'shearY', newShearYFunc);
  ...
  function overrideTextFunction() {
    _originalTextFunc = getOriginalFunction('text');
    const newTextFunc = function(content, x, y, maxWidth, maxHeight) {
      ...
      callOriginalFunction(_originalTextFunc, _p5Instance, arguments);
    };
    overrideFunction(_p5Instance, 'text', newTextFunc);
  ...
  function exportSVG() {
    ...
    for (let cmd of _commands) {
      ...
      } else if (cmd.type === 'spline') {
        svgContent += getSvgStrSpline(cmd);
    ...
    headerContent += `<!-- Generated using p5.js v.${p5.VERSION} and p5.plotSvg v.${p5plotSvg.VERSION}: -->\n`;
  ...
  function getSplinePathData(points, closed, tightness = 0, includeEnds = true) {
    ...
    let d = `M ${formatNumber(startPoint.x)},${formatNumber(startPoint.y)}`;
    for (let i = startIndex; i <= endIndex; i++) {
      ...
      d += ` C ${formatNumber(c1x)},${formatNumber(c1y)}`;
      d += ` ${formatNumber(c2x)},${formatNumber(c2y)}`;
      d += ` ${formatNumber(p2.x)},${formatNumber(p2.y)}`;
    }
    if (closed) d += ' Z';
    return d;
  }
  ...
  function getSvgStrMultiContourPath(cmd, styleStr, transformStr) {
    ...
    let items = cmd.type === 'polyline' ? cmd.vertices : cmd.segments;
  ...
  function generateSimpleContourPath(contour) {
    ...
    for (let i = 0; i < contour.vertices.length; i++) {
      let v = contour.vertices[i];
      let x = formatNumber(v.x);
      let y = formatNumber(v.y);
      if (i === 0) {
        d += `M ${x},${y}`;
      } else {
        d += ` L ${x},${y}`;
  ...
  function generateComplexContourPath(contour) {
    let verts = contour.vertices;
    if (verts.length === 0) return '';

    if (verts.every(v => v.type === 'spline')) {
      let firstSpline = verts[0];
    ...
    // Start with moveTo for first vertex
    let d = `M ${formatNumber(verts[0].x)},${formatNumber(verts[0].y)}`;
    ...
    for (let i = 1; i < verts.length; i++) {
      ...
      if (seg.type === 'vertex') {
      ...
      } else if (seg.type === 'bezierPoint') {
        let order = seg.order || _svgBezierOrder;
        if (order === 2 && i + 1 < verts.length) {
          let endPt = verts[i + 1];
          d += ` Q ${formatNumber(seg.x)},${formatNumber(seg.y)}`;
          d +=   ` ${formatNumber(endPt.x)},${formatNumber(endPt.y)}`;
          i += 1;
        } else if (i + 2 < verts.length) {
          let c2 = verts[i + 1];
          let endPt = verts[i + 2];
          d += ` C ${formatNumber(seg.x)},${formatNumber(seg.y)}`;
          d +=   ` ${formatNumber(c2.x)},${formatNumber(c2.y)}`;
          d +=   ` ${formatNumber(endPt.x)},${formatNumber(endPt.y)}`;
          i += 2;
        }
        ...
        if (i > 2) {
          let sx1 = verts[Math.max(0, i - 3)].x;
          let sy1 = verts[Math.max(0, i - 3)].y;
          let sx2 = verts[Math.max(0, i - 2)].x;
          let sy2 = verts[Math.max(0, i - 2)].y;
          let sx3 = verts[i - 1].x;
          let sy3 = verts[i - 1].y;
          let sx4 = verts[i].x;
          let sy4 = verts[i].y;
          ...
          d += ` C ${formatNumber(targetSegment[0])},${formatNumber(targetSegment[1])}`;
          d +=   ` ${formatNumber(targetSegment[2])},${formatNumber(targetSegment[3])}`;
          d +=   ` ${formatNumber(targetSegment[4])},${formatNumber(targetSegment[5])}`;
        }
      }
    }
    if (contour.closed) d += ' Z';
  ...
  function getSvgStrPoly(cmd) {
    ...
    if (cmd.type === 'polyline') {
      ...
      let d = '';
      if (cmd.segments.every(seg => seg.type === 'spline')) {
        let firstSpline = cmd.segments[0];
        d = getSplinePathData(
          cmd.segments,
          cmd.closed,
          firstSpline.tightness,
        ...
        d = `M ${formatNumber(cmd.segments[0].x)},${formatNumber(cmd.segments[0].y)}`;
        ...
        for (let i = 1; i < cmd.segments.length; i++) {
          ...
          if (seg.type === 'vertex') {
            ...
            let order = seg.order || _svgBezierOrder;
            if (order === 2 && i + 1 < cmd.segments.length) {
              let endPt = cmd.segments[i + 1];
              d += ` Q ${formatNumber(seg.x)},${formatNumber(seg.y)}`;
              d +=   ` ${formatNumber(endPt.x)},${formatNumber(endPt.y)}`;
              i += 1;
            } else if (i + 2 < cmd.segments.length) {
              let c2 = cmd.segments[i + 1];
              let endPt = cmd.segments[i + 2];
              d += ` C ${formatNumber(seg.x)},${formatNumber(seg.y)}`;
              d +=   ` ${formatNumber(c2.x)},${formatNumber(c2.y)}`;
              d +=   ` ${formatNumber(endPt.x)},${formatNumber(endPt.y)}`;
              i += 2;
  ...
  function getP5Constant(name) {
    if (_p5Instance && typeof _p5Instance[name] !== 'undefined') {
      return _p5Instance[name];
    }
    const globalTarget = getGlobalTarget();
  ...
  function getCurrentBezierOrder() {
    const order = _p5Instance?._renderer?.states?.bezierOrder;
    return (order === 2 || order === 3) ? order : _svgBezierOrder;
  }
  ...
  function setOriginalBezierOrder(order) {
    ...
    if (typeof _originalBezierOrderFunc === 'function') {
      callOriginalFunction(_originalBezierOrderFunc, _p5Instance, [order]);
    } else if (_p5Instance?._renderer?.states) {
      _p5Instance._renderer.states.bezierOrder = order;
    }
    if (order === 2 || order === 3) {
      _svgBezierOrder = order;
    }
  ...
  function getCurrentSplineTightness() {
    const tightness = _p5Instance?._renderer?.states?.splineProperties?.tightness;
    if (typeof tightness === 'number') return tightness;
    return _svgCurveTightness;
  }
  ...
  function getCurrentSplineEndsMode() {
    const endsMode = _p5Instance?._renderer?.states?.splineProperties?.ends;
    return (typeof endsMode !== 'undefined') ? endsMode : _svgSplineEndsMode;
  }
  ...
  function setOriginalSplineProperty(property, value) {
    ...
    if (typeof _originalSplinePropertyFunc === 'function') {
      callOriginalFunction(_originalSplinePropertyFunc, _p5Instance, [property, value]);
    } else if (_p5Instance?._renderer?.states?.splineProperties) {
      _p5Instance._renderer.states.splineProperties[property] = value;
    }
    if (property === 'tightness') {
      _svgCurveTightness = value;
    } else if (property === 'ends') {
  ...
  function beginCurveVertexCompatIfNeeded() {
    if (_bCurveVertexCompatActive) return;
    _curveVertexCompatPreviousEndsMode = getCurrentSplineEndsMode();
    setOriginalSplineProperty('ends', getP5Constant('EXCLUDE'));
    _bCurveVertexCompatActive = true;
  }
  ...
  function endCurveVertexCompatIfNeeded() {
    if (!_bCurveVertexCompatActive) return;
    setOriginalSplineProperty('ends', _curveVertexCompatPreviousEndsMode);
    _curveVertexCompatPreviousEndsMode = undefined;
    _bCurveVertexCompatActive = false;
  }
  ...
  function shouldIncludeSplineEnds(endsMode) {
    if (_p5Instance && typeof _p5Instance.EXCLUDE !== 'undefined' && endsMode === _p5Instance.EXCLUDE) {
      return false;
    }
    return true;
  }
  ...
  function overrideColorModeFunction() {
    _originalColorModeFunc = getOriginalFunction('colorMode');
    const newColorModeFunc = function() {
      ...
      callOriginalFunction(_originalColorModeFunc, _p5Instance, arguments);
    };
    overrideFunction(_p5Instance, 'colorMode', newColorModeFunc);
  ...
  function overrideClipFunction() {
    _originalClipFunc = getOriginalFunction('clip');
    if (typeof _originalClipFunc !== 'function') return;
    const newClipFunc = function() {
      if (_bRecordingSvg && !_bClipWarningShown) {
        console.warn("p5.plotSvg: p5's clip() function is not currently supported for SVG export.");
        _bClipWarningShown = true;
      }
      callOriginalFunction(_originalClipFunc, _p5Instance, arguments);
    };
    overrideFunction(_p5Instance, 'clip', newClipFunc);
  ...
  function overrideStrokeFunction() {
    _originalStrokeFunc = getOriginalFunction('stroke');
    const newStrokeFunc = function(...args) {
      ...
      callOriginalFunction(_originalStrokeFunc, _p5Instance, args);
    };
    overrideFunction(_p5Instance, 'stroke', newStrokeFunc);
