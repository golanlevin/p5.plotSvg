...
(function(global) {
  ...
  */
  ...
  function overrideBeginContourFunction() {
    _originalBeginContourFunc = _p5Instance.beginContour;
    _p5Instance.beginContour = function() {
      if (_bRecordingSvg) {
  ...
  function overrideEndContourFunction() {
    _originalEndContourFunc = _p5Instance.endContour;
    _p5Instance.endContour = function(mode) {
      if (_bRecordingSvg) {
  ...
  function overrideClipFunction() {
    _originalClipFunc = _p5Instance.clip;
    _p5Instance.clip = function() {
      ...
      _originalClipFunc.apply(this, arguments);
    };
  }
