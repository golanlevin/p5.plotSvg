...
(function(global) {
  ...
  */
   ...
   * recording SVG.
   */
  function installPrototypeMethods(p5Ctor) {
    if (!p5Ctor || !p5Ctor.prototype) return;
    const fn = p5Ctor.prototype;
    ...
    const isExplicitP5Instance = function(value) {
    ...
    addMethod('beginRecordSvg', function(p5InstanceOrFilename, maybeFilename) {
      const globalTarget = getGlobalTarget();
      if (p5InstanceOrFilename === globalTarget || isExplicitP5Instance(p5InstanceOrFilename)) {
