...
<details><summary><strong>Instructions rapides en français • cliquez</strong></summary>
...
<details><summary><strong>Instrucciones rápidas en español • haga clic</strong></summary>
...
<details><summary><strong>日本語での簡単な説明 • クリック</strong></summary>
...
<details><summary><strong>快速说明（中文）• 点击</strong></summary>
...
* This is not a library for [computational geometry](https://www.cgal.org/) in p5. For problems like computing [offset curves](https://en.wikipedia.org/wiki/Parallel_curve) or shape-shape intersections, clipping, and occlusions, consider using libraries like [Paper.js](http://paperjs.org/features/#svg-import-and-export),  [Shapely](https://shapely.readthedocs.io/en/stable/), or [occult](https://github.com/LoicGoulefert/occult).
...
9. [**plotSvg_addon_example**](examples/plotSvg_addon_example/README.md): Demonstrates the add-on-style API in p5.js v1/v2 and global/instance mode.
...
<!-- codex resume 019dd25a-8fba-7291-bf17-3d0f9d6d680d -->
